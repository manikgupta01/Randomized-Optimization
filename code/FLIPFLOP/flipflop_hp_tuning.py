...
for i in range(10):
    ...
    best_state, best_fitness = mlrose.random_hill_climb(problem, max_attempts=10,
            max_iters=2000, restarts=i, init_state=None, curve=False, random_state=RANDOM_STATE)
...
plt.xlabel("Restart")
plt.ylabel("Fitness")
plt.savefig('flipflop_hp_RHC.png', bbox_inches = "tight")
...
for i in range(10):
    ...
    best_state, best_fitness = mlrose.simulated_annealing(problem, schedule=schedule, max_attempts=10,
                max_iters=2000,init_state=None,curve=False,random_state=RANDOM_STATE)
...
plt.ylabel("Fitness")
plt.savefig('flipflop_hp_SA.png', bbox_inches = "tight")
...
plt.ylabel("Fitness")
plt.savefig('flipflop_hp_GA.png', bbox_inches = "tight")
...
plt.xlabel("Iterations")
plt.ylabel("Fitness")
plt.savefig('flipflop_hp_MIMIC.png', bbox_inches = "tight")
